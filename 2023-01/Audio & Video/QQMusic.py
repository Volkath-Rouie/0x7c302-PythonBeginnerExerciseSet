...
os.chdir("C:/Users/Sanctuary of Pilgrim/Music/")
...
class MusicdlGUI(QWidget):
    def __init__(self, parent=None):
        ...
        # 初始化
        config = {'logfilepath': 'musicdl.log', 'savedir': 'Pyget', 'search_size_per_source': 2, 'proxies': {}}
        ...
        # 输入框
        self.label_keyword = QLabel('Song Keywords:')
        self.lineedit_keyword = QLineEdit('Pilgrim Hill')
        self.button_keyword = QPushButton('Search:')
        # 搜索结果表格
        self.results_table = QTableWidget()
        self.results_table.setColumnCount(7)
        self.results_table.setHorizontalHeaderLabels(['Chapter', 'Singer', 'Song', 'Size', 'Duration', 'Ablum', 'Source'])
